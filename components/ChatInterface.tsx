...
//   }
//   // Format the streamed response of tool execution
...
//       // Create a SSE parser and stream reader
//       const parser = createSSEParser()
//       const reader = response.body.getReader()

//       // Process the stream chunks
//       await processStreamedResponse(reader, async (chunk) => {
//         // Parse SSE messages form the chunk
...
//               // Handle end of tool execution ( e.g. API calls, file operations)
...
//                   fullResponse =
//                     fullResponse.slice(0, lastTerminalIndex) +
...
//       // Remove the optimisitic message if there was an error
//       setMessages((prevMessages) =>
//         prevMessages.filter((m) => m._id !== optimisticMessage._id)
//       )

//       // Set streaming response to error message
//       setStreamedResponse(
//         formatTerminalOutput(
//           "error",
